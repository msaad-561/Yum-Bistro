    ...
    <div className="min-h-screen bg-white text-black font-sans pb-20">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          <h1 className="font-heading text-5xl tracking-widest text-black mb-6 uppercase inline-block relative">
            CHECKOUT
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between border-b border-gray-200 pb-4 mb-8">
            <h2 className="font-heading text-3xl tracking-wider text-black uppercase">INFO</h2>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-3xl p-6 mb-8">
              ...
              <div key={item.cartItemId} className="flex items-center space-x-4">
                ...
                <div className="flex-grow flex flex-col justify-center space-y-1">
                  <div className="flex justify-between items-start">
                    <h3 className="font-heading tracking-wider text-xl text-black uppercase">{item.name}</h3>
          ...
          <div className="flex items-end justify-between">
            <span className="font-heading text-3xl tracking-widest text-black">TOTAL BILL</span>
            <span className="font-heading text-5xl tracking-widest text-red-600">PKR {totalBill.toFixed(0)}</span>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-12">
          <button 
            ...
            className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white font-heading text-2xl tracking-widest py-5 rounded-full transition-colors flex items-center justify-center space-x-3 uppercase"
          >
          ...
          <a href="tel:03353131204" className="w-full bg-red-600 hover:bg-red-700 text-white font-heading text-2xl tracking-widest py-5 rounded-full transition-colors flex items-center justify-center space-x-3 uppercase">
